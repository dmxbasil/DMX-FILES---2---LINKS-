    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                return
        await m.reply_text(
            text='𝙷𝙻𝙾 𝙱𝚄𝙳𝙳𝚈 ☻︎\n𝙸 𝙰𝙼 𝙰 𝙸𝙽𝚂𝚃𝙰𝙽𝚃 𝙵𝙸𝙻𝙴 𝚃𝙾 𝙻𝙸𝙽𝙺 𝙶𝙴𝙽𝙰𝚁𝙰𝚃𝙴𝚁 𝙱𝙾𝚃 𝙾𝙵 𝙳𝙼𝚇 𝙶𝚁𝙾𝚄𝙿 ..𝙽𝙾𝚆 𝙸𝙰𝙼 𝙲𝚄𝚁𝚁𝙴𝙽𝚃𝙻𝚈 𝙵𝚄𝙻𝙻𝚈 𝙾𝙿𝙴𝙽 𝚂𝙾𝚄𝙲𝚁𝙴 𝚈𝙾𝚄 𝙲𝙰𝙽 𝙰𝙻𝚂𝙾 𝚄𝚂𝙴 𝙼𝙴 \n\n𝚂𝙴𝙽𝙳 𝙼𝙴 𝙰𝙽𝚈 𝙵𝙸𝙻𝙴 𝙵𝙾𝚁𝙼 𝙰𝙽𝚈 𝚆𝙷𝙴𝚁𝙴 |»«| 𝙰𝙽𝙳 𝙲𝙻𝙾𝚂𝙴 𝚈𝙾𝚄𝚁 𝚂𝙼𝙰𝙻𝙻 𝙴𝚈𝙴𝚂 𝙰𝙽𝙳 𝙲𝙾𝚄𝙽𝚃 𝚃𝙾 𝙾𝙽𝙴(:_-_:)',
            reply_markup=InlineKeyboardMarkup(
                [
